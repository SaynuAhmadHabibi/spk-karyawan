...
<div class="glass-panel p-8 max-w-md mx-auto">
    <h2 class="text-2xl font-bold mb-6 text-gray-800"><i class="bi bi-exclamation-triangle-fill text-danger mr-2"></i> Hitung Punishment</h2>
    <form action="index.php" method="GET">
        ...
        <div class="flex gap-3">
            ...
            <a href="index.php?act=dashboard" class="btn-glass px-6 py-2.5 text-muted hover:text-gray-800">Batal</a>
        </div>
    </form>
</div>
